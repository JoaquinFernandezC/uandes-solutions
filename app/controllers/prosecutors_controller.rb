class ProsecutorsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @prosecutor.save
        format.html { redirect_to @prosecutor, notice: 'Prosecutor was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @prosecutor.update(prosecutor_params)
        format.html { redirect_to @prosecutor, notice: 'Prosecutor was successfully updated.' }
