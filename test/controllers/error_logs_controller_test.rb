...
class ErrorLogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create error_log" do
    assert_difference('ErrorLog.count') do
      post error_logs_url, params: { error_log: { action: @error_log.action, code: @error_log.code, privacy: @error_log.privacy } }
    end
  ...
  test "should update error_log" do
    patch error_log_url(@error_log), params: { error_log: { action: @error_log.action, code: @error_log.code, privacy: @error_log.privacy } }
